...
# now render hallucinations (yes, really)
flydra_render_hallucinations --db $DB $ids
flydra_render_hallucinations --db $DB --white $ids
flydra_render_contrast --db $DB --source hluminance    --target hcontrast    $ids
flydra_render_contrast --db $DB --source hluminance_w  --target hcontrast_w  $ids
